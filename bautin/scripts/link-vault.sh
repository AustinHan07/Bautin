...
# Sets:  skills.create_dir, terminal.docker_volumes (vault at /vault, bautin/ at /bautin:ro)
...
echo "config: skills.create_dir and terminal.docker_volumes set for $PROFILE"
